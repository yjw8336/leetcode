...
class ValidateIpAddress {
    ...
    class Solution {
        java.util.regex.Pattern ipV4Reg = java.util.regex.Pattern.compile(
                "(([0-9]|[1-9][0-9]|1[0-9][0-9]|2([0-4][0-9]|5[0-5]))\\.){4}");
        java.util.regex.Pattern ipV6Reg = java.util.regex.Pattern.compile("(([0-9]|[a-f]|[A-F]){1,4}:){8}");

        public String validIPAddress(String IP) {
            if (ipV4Reg.matcher(IP + ".").matches()) {
                return "IPv4";
            }
            if (ipV6Reg.matcher(IP + ":").matches()) {
                return "IPv6";
            }
            return "Neither";
        }
